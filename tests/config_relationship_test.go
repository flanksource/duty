...
var _ = ginkgo.Describe("Config relationship recursive", ginkgo.Ordered, func() {
	...
	var (
		A = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("A")}
		B = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("B")}
		C = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("C")}
		D = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("D")}
		E = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("E")}
		F = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("F")}
		G = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("G")}
		H = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("H")}

		L = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("L")}
		M = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("M")}
		N = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("N")}
		O = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("O")}
		P = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("p")}

		U = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("U")}
		V = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("V")}
		W = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("W")}
		X = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("X")}
		Y = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("Y")}
		Z = models.ConfigItem{ID: uuid.New(), Tags: lo.ToPtr(types.JSONStringMap{"namespace": "test-relationship"}), Name: lo.ToPtr("Z")}
	)
