...
CREATE OR REPLACE TRIGGER incident_to_incident_history
    AFTER INSERT
    ON incidents
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER incident_status_to_incident_history
    AFTER UPDATE
    ON incidents
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER responder_to_incident_history
    AFTER INSERT
    ON responders
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER evidence_to_incident_history
    AFTER INSERT
    ON evidences
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER responder_comment_to_incident_history
    AFTER INSERT
    ON comments
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER hypothesis_status_to_incident_history
    AFTER INSERT
    ON hypotheses
    FOR EACH ROW
