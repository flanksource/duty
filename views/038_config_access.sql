...
-- Note: config_access_logs stores at most one log per (config_id, external_user_id, scraper_id).
-- Multiple rows for the same user-config pair are possible if detected by different scrapers.
