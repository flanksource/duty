...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (h *HTTPConnection) DeepCopyInto(out *HTTPConnection) {
	*out = *h
	h.HTTPBasicAuth.DeepCopyInto(&out.HTTPBasicAuth)
	h.Bearer.DeepCopyInto(&out.Bearer)
	h.OAuth.DeepCopyInto(&out.OAuth)
	h.TLS.DeepCopyInto(&out.TLS)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPConnection.
func (h *HTTPConnection) DeepCopy() *HTTPConnection {
	if h == nil {
		return nil
	}
