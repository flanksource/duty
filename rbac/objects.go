...
var dbResourceObjMap = map[string]string{
	...
	"applications":                              policy.ObjectCatalog,
	"config_access_unwrapped":                   policy.ObjectCatalog,
	"config_access_summary":                     policy.ObjectCatalog,
	"config_backups":                            policy.ObjectCatalog,
	"config_backup_restores":                    policy.ObjectCatalog,
