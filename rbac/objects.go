...
var dbResourceObjMap = map[string]string{
	...
	"rpc/config_analysis_filter_options":        policy.ObjectCatalog,
	...
	"rpc/record_notification_health":            policy.ObjectAuthConfidential,
	"rpc/refresh_notification_health":           policy.ObjectAuthConfidential,
	"notification_health_states":                policy.ObjectAuthConfidential,
	"notification_health_episodes":              policy.ObjectAuthConfidential,
	"notification_deliveries":                   policy.ObjectAuthConfidential,
	...
	"rpc/refresh_config_cost_summary":                   policy.ObjectDatabaseSystem,
